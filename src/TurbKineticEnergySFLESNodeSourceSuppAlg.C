...
// Class Definition
//==========================================================================
// TurbKineticEnergySFLESNodeSourceSuppAlg - base class for algorithm
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
TurbKineticEnergySFLESNodeSourceSuppAlg::TurbKineticEnergySFLESNodeSourceSuppAlg(
  Realm &realm)
    ...
    nDim_(realm.meta_data().spatial_dimension())
{
  ...
  alpha_ = meta_data.get_field<ScalarFieldType>(stk::topology::NODE_RANK, "adaptivity_parameter");
...
//--------------------------------------------------------------------------
void
TurbKineticEnergySFLESNodeSourceSuppAlg::setup()
{
...
//--------------------------------------------------------------------------
void
TurbKineticEnergySFLESNodeSourceSuppAlg::node_execute(
  double *lhs,
  double *rhs,
  stk::mesh::Entity node)
{
  ...
  const double alpha      = *stk::mesh::field_data(*alpha_, node );
